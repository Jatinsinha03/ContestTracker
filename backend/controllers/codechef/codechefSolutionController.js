...
exports.fetchCodechefSolution = async (req, res) => {
    try {
        const titlesAndLinks = await setupPuppeteer(async (page) => {
            await page.goto('https://www.youtube.com/playlist?list=PLcXpkI9A-RZIZ6lsE0KCcLWeKNoG45fYr', { waitUntil: 'networkidle2', timeout: 60000 });
            return await page.evaluate(() => {
                ...
                return titleNodes.map(node => {
                    ...
                    const match = fullTitle.match(/(Codechef|CodeChef) Starters \d+/); // Regex to find 'Weekly Contest' or 'Biweekly Contest' followed by numbers
